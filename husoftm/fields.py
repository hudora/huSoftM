...
'EBP00': { # Bestellpositions-Datei
          ...
          # 'BPFNR ': 'Firma                       ',
          # 'BPBSTN': 'Bestell-Nummer              ',
          # 'BPBSTP': 'Bestell-Position            ',
          # 'BPBSAB': 'Nummer des bez. Rahmenvert. ',
          # 'BPBSAP': 'Pos-Nr des bez. Rahmenvert. ',
          # 'BPTGAR': 'Tage bis Druck Abr-Pos      ',
          # 'BPSBNR': 'Sachb. Erfassung            ',
          # 'BPSBAE': 'Sachb.letzte ¢nderung       ',
          ...
          # 'BPDTWU': 'Wunsch-Termin               ',
          # 'BPDTBE': 'Erstmals best{tigter Termin ',
          # 'BPDTBL': 'Letzter best{tigter Termin  ',
          # 'BPDTLZ': 'Datum letzter Zugang        ',
          # 'BPDTER': 'Datum Erfassung CJJMMTT     ',
          # 'BPDTAE': 'Datum l. ¢nderung CJJMMTT   ',
          # 'BPDTAL': 'Datum der Lieferanten-AB    ',
          # 'BPDFSL': 'Dateif}hrungs-Schl}ssel     ',
          # 'BPSTAT': 'Satzstatus                  ',
           },
