...
'BKNRKD': dict(name='auftragsnumer_kunde',     format='A20',
...
'BKJWKW': dict(name='lundenwunschtermin_woche',format='P5.0', 
...
'BKDTLT': dict(name='liefertermin',            format='P7.0', 
               doc='''AAK00.AKDTLT Termin, zu dem die Ware das Lager verlassen soll. Für unbestimmte
...
'BKHERK': dict(name='Herkunft des Auftrags',   format='A1',   
...
'BKX3LB': dict(name='Lieferbedingung Auftr',   format='A3',   
...
'BKKZTF': dict(name='Teillieferung zulässig',  format='S1.0', 
...
'BADTLT': dict(name='liefertermin',             format='P7.0', required=True, 
...
'BAANPO': dict(name='angebotsposition',         format='P5.0',  
               ...
               aus SSt Einkauf'''),
'BAEAN':  dict(name='EAN des Artikels',         format='P13.0', 
...
#               In der Validierungsdatei kann zu diesem Rabattschlüssel eine Rabattgruppe hinterlegt werden. Außerdem kann dort für Positionsrabatte angegeben werden, ob es sich um einen Rabatt handelt, der den Positionswert vermindert, oder um einen Zuschlag, der ihn erhöht.'''),
...
# BAVGAR Vorgangsart VrggA A 4 321 324 ABK00. ABK00F01. BKVGAR Es gibt besondere Vorgangsarten (#RET, *AAK, *XEA, *ITS, *CSA), die sich vom Standardparameter nicht nur durch die Parameterisierung unterscheiden. Für alle anderen Vorgangsarten (*NO*BLANK) kann über einen eigenen Parametersatz eine unterschiedliche Verarbeitung in SSt Auftrag erreicht werden, z.B. Angebot erzeugen. Gültige Werte sind: *BLANK Standardparameter #RET Auftrag aus Retourenverwaltung *AAK Änderung eines existierenden Auftrags *XEA Auftrag aus Bestellung (XEA00) *ITS Auftrag aus Intershop *CSA Auftrag aus B2B /CSA *OFF Auftrag aus Offline-Warenkorb *TST Übernahme Altaufträge in neue Vorgänge *NO*BLANK eigener Standardparameter
# BAFNRB  Herkunftsfirma HkFirma  A   2   325 326 AAP00. AAP00F01. APRES1 Werden die Positionen über die SSt Einkauf/Auftrag (XEA00) erzeugt, so ist hier die Firma des Ursprungsbelegs (= Bestellfirma) vermerkt. Gültige Werte sind: *FIRM gültige Firma
# BAKZUP  Geplanter Update Gpln Upd   A   1   327 327 XREF. XREFF01. XXA1 Gültige Werte sind: *BLANK neue Position erzeugen U vorhandene Position aktualisieren D vorhandene Position löschen
# BAUAPR  Umrechnungsart UmrgA    A   1   328 328 XREF. XREFF01. XAUAPR Die artikelbezogenen Preise können in einer von der Bestandsführungseinheit abweichenden Mengeneinheit hinterlegt werden. Die Umrechnung zwischen diesen Mengeneinheiten erfolgt über einen Umrechnungsfaktor. Je nach Umrechnungsart dient dieser zur Multiplikation oder Division. Gültige Werte sind: *ZERO Faktor 1 Divisor
# BAMEGB  Mengeneinheit der Umverpackung MEh UVpk S   2.0 329 330 AAP00. AAP00F01. APMEGB Gültige Eingaben müssen in der Validierungsdatei unter dem zugehörigen Prüftyp hinterlegt sein. Je nach Parameterisierung können die Positionen über die Mengeneinheit der Umverpackung erfasst werden. Diese Mengeneinheit dient nur als Eingabehilfe und wird informationshalber im Datensatz vermerkt.
# BAKZZT  Verfügbarkeitsprüfung Prf Vfgb  A   1   331 331 XREF. XREFF01. XXA1 Gültige Werte sind: *BLANK ohne Bestandsprüfung ¥ Verfügbarkeit geprüft @ bereits zugeteilt
# BAFNRX  Firma Bestandsführung FaBstdFhrg    A   2   332 333 AAP00. AAP00F01. APFNRX Gültige Werte sind: *FIRM gültige Firma 
# BASNPF  Satznummer Konditionsermittlung StzNrKondE  P   9.0 343 347 XREF. XREFF01. XASNPF Die im Lauf der Konditionsermittlung gefundenen Konditionen werden in einer eigenen Datei gespeichert. Zugriff erfolgt über die Satznummer der Konditionsermittlung.
# BAKZ01  Reservefeld RsvFld  S   1.0 356 356 XREF. XREFF01. XXKZ STB: Zuteilungspriorität IAA00 Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAKZ02  Preisstufe Preisstufe   S   1.0 357 357 XREF. XREFF01. XXKZ Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAKZ03 Steuerung Übernahme Strg Übn S 1.0 358 358 XREF. XREFF01. XXKZ  Bearbeitungszustand vor letzter Übernahme, benötigt für den Wiederanlauf AAU29 Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAPRVK Provisionskennzeichen ProvKz A 2 359 360 XREF. XREFF01. XXPRVK ANZFELDART: UPTYP10 Über die Zuordnung Vertreter / Provisionskennzeichen wird der Provisionssatz ermittelt. Wird bei der Prüfung eingesetzt Gültige Werte sind: *BLANK keine Provision P1 Provisionskennzeichen 1 P2 Provisionskennzeichen 2 P3 Provisionskennzeichen 3
...
# 4 wurde übernommen 
# *ZERO nicht geprüft
# BADTAE Änderungsdatum ÄndDatum P 7.0 362 365 XREF. XREFF01. XXDTAE Datum der letzten Änderung des Datensatzes. Datum der letzten Änderung/Korrektur
# BADTPR Datum letzte Prüfung Dt ltz Prf P 7.0 366 369 ABK00. ABK00F01. BKDTPR
# BAKE01 Artikelgruppe eingesetzt mit ArtGrp S 1.0 370 370 XREF. XREFF01. XXKZ Artikelgruppe wird eingesetzt aus ... Gültige Werte sind: *ZERO aus Übergabe 1 per Automatik eingesetzt
# BAKE02 Artikelhauptgruppe eingesetzt mitArtHGrp S 1.0 371 371 XREF. XREFF01. XXKZ Artikelhauptgruppe wird eingesetzt aus ... Gültige Werte sind: *ZERO aus Übergabe 1 per Automatik eingesetzt
# BAKE03  Lager eingesetzt Lg egszt   S   1.0 372 372 XREF. XREFF01. XXKZ Lager wird eingesetzt aus ... Gültige Werte sind: *ZERO aus Übergabe 1 per Automatik eingesetzt
# BAKE04  Mengeneinheit eingesetzt MEh egszt  S   1.0 373 373 XREF. XREFF01. XXKZ Mengeneinheit wird eingesetzt aus ... Gültige Werte sind: *ZERO aus Übergabe 1 per Automatik eingesetzt
# BAKE05  Liefertermin eingesetzt LfTrm egsz  S   1.0 374 374 XREF. XREFF01. XXKZ Liefertermin wird eingesetzt aus ... Gültige Werte sind: *ZERO aus Übergabe 1 per Automatik eingesetzt
# BAKE06 Preis eingesetzt Pr egszt S 1.0 375 375 XREF. XREFF01. XXKZ Festlegung, ob/wie der Preis eingesetzt/ermittelt wird Gültige Werte sind: 1 Preis bei Stapelprüfung eingesetzt 2 Preis bei Dialogprüfung auf 0 Der Preis wurde bei der Dialogkorrektur auf 0 geändert. 3 Preis wird nicht überschrieben Der angegebene Preis 0 soll bei der Stapelprüfung nicht überschrieben werden. *ZERO Preis lt. Artikelstamm bzw. Preisdatei Bei Preis = 0 soll bei der Stapelprüfung der aktuelle Preis lt. Artikelstamm bzw. Preisdatei eingesetzt werden.
# BAKE07  Rabatt eingesetzt Rb egszt  S   1.0 376 376 XREF. XREFF01. XXKZ Festlegung, ob/wie der Rabatt eingesetzt/ermittelt wird. Gültige Werte sind: 1 Preisergänzung bei Stapelprüfung 2 Rabatt manuell auf 0 bei Dialog 3 keine Rabattergänzung bei Dialog *ZERO Rabatt lt. Artikelstamm bzw. Preisdatei
# BAKE08  Naturalrabattangaben eingesetzt NatRb egsz  S   1.0 377 377 XREF. XREFF01. XXKZ Angaben zu Naturalrabatt werden eingesetzt aus ... Gültige Werte sind: *ZERO aus Übergabe 1 per Automatik eingesetzt
# BAKE09  Kennzeichen Kz J/N  S   1.0 378 378 XREF. XREFF01. XXKZ Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAKE10  Kennzeichen Kz J/N  S   1.0 379 379 XREF. XREFF01. XXKZ Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAKE11  Kennzeichen Kz J/N  S   1.0 380 380 XREF. XREFF01. XXKZ Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAKE12  Kennzeichen Kz J/N  S   1.0 381 381 XREF. XREFF01. XXKZ Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAKE13  Kennzeichen Kz J/N  S   1.0 382 382 XREF. XREFF01. XXKZ Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAKE14  Kennzeichen Kz J/N  S   1.0 383 383 XREF. XREFF01. XXKZ Gültige Werte sind: *ZERO Funktion nicht eingesetzt 1 Funktion eingesetzt
# BAKE15  Steuerung Sortimentsrabatt/-preis StrgSrtmRb    S   1.0 384 384 AAP00. AAP00F01. APKZET Festlegung, ob die Position für die Ermittlung von Sortimentsrabatten oder -preisen berücksichtigt wird, und ob für sie Sortimentsrabatte oder -preise gewährt werden dürfen. Gültige Werte sind: *ZERO Menge berücksichtigen, Rabatt gilt 1 Menge berücksichtigen, kein Rabatt 2 Menge nicht berücksichtigen, kein Rabatt
# BAKZS1  Rabatt 1 ist Sortimentsrabatt Rb1 SrtmRb    S   1.0 385 385 XREF. XREFF01. XXKZ Festlegung, ob der entsprechende Rabatt (1 bis 4) ein Sorti- mentsrabatt ist. Angabe wird per Programm bei der Übernahme eingesetzt. Gültige Werte sind: *ZERO Rabatt ist kein Sortimentsrabatt 1 Rabatt ist Sortimentsrabatt
# BAKZS2  Rabatt 2 ist Sortimentsrabatt Rb2 SrtmRb    S   1.0 386 386 ABA00. ABA00F01. BAKZS1 Festlegung, ob der entsprechende Rabatt (1 bis 4) ein Sorti- mentsrabatt ist. Angabe wird per Programm bei der Übernahme eingesetzt. Gültige Werte sind: *ZERO Rabatt ist kein Sortimentsrabatt 1 Rabatt ist Sortimentsrabatt
# BAKZS3  Rabatt 3 ist Sortimentsrabatt Rb3 SrtmRb    S   1.0 387 387 ABA00. ABA00F01. BAKZS1 Festlegung, ob der entsprechende Rabatt (1 bis 4) ein Sorti- mentsrabatt ist. Angabe wird per Programm bei der Übernahme eingesetzt. Gültige Werte sind: *ZERO Rabatt ist kein Sortimentsrabatt 1 Rabatt ist Sortimentsrabatt
# BAKZS4  Rabatt 4 ist Sortimentsrabatt Rb4 SrtmRb    S   1.0 388 388 ABA00. ABA00F01. BAKZS1 Festlegung, ob der entsprechende Rabatt (1 bis 4) ein Sortimentsrabatt ist. Angabe wird per Programm bei der Übernahme eingesetzt. Gültige Werte sind: *ZERO Rabatt ist kein Sortimentsrabatt  1 Rabatt ist Sortimentsrabatt   
# BAAUFN  Auftrag Auftrag P   7.0 389 392 XREF. XREFF01. XXAUFN Nummer des Auftrags  Die Angabe wird per Programm bei der Übernahme eingesetzt.  Der Nummernbereich wird im Parameter Nummernkreise festgelegt.  
# BAAUPO  Auftragsposition AufPos P   5.0 393 395 XREF. XREFF01. XXAUPO Die Angabe wird per Programm bei der Übernahme eingesetzt.  
# BAOWRT  Positionswert PosWrt    P   15.2  396 403 XREF. XREFF01. XAAWRT Angabe wird per Programm bei der Übernahme eingesetzt.  
...
def nachschub(mengen, liefertermin, auftragsnumer_kunde, abgangslager=26, zugangslager=100,
              kundennummer='17200', belegtexte=[]):
    """Stellt einen Nachschubauftrag von Lager abgangslager (z.B. Geo) an Lager zugangslager ins System."""
    
    # this should be done by the caller:
    # if auftragsnumer_kunde_bekannt(auftragskennzeichen):
    ...
    auftragskennzeichen          = auftragsnumer_kunde
    
    kopf = Kopf()
    kopf.vorgang                 = vorgangsnummer
    kopf.auftragsnumer_kunde     = auftragskennzeichen
    kopf.kundennummer            = '%8s' % kundennummer
    kopf.auftragsart, kopf.sachbearbeiter = 'U', 1
    kopf.abgangslager, kopf.zugangslager = abgangslager, zugangslager
    
    kopf.liefertermin            = date2softm(liefertermin)
    kopf.kundenwunschtermin      = date2softm(liefertermin)
    # Diese Daten setze ich in der Hoffnung, dass die Stapelschnittstelle weniger 'rumzickt.
    kopf.bearbeitungskennzeichen = 4
    #kopf.erfassungsdatum         = date2softm(datetime.date.today())
    #kopf.kundenauftragsdatum     = date2softm(datetime.date.today())
    
    positionen = []
    texte = []
    lastpositionstext = ''
    for menge, artnr, anmerkung in mengen:
        position                  = Position()
        positionen.append(position)
        position.position, position.vorgangsposition = len(positionen), len(positionen)
        position.bestellmenge     = menge
        position.artikel          = artnr
        position.vorgang          = vorgangsnummer
        position.liefertermin     = date2softm(liefertermin)
        position.erfassungsdatum  = date2softm(datetime.date.today())
        if anmerkung != lastpositionstext:
            lastpositionstext     = anmerkung
            text = Text()
            texte.append(text)
    ...
    for belegtext in belegtexte:
        text = Text()
        texte.append(text)
        text.textnummer       = len(texte)
        text.text             = belegtext
        text.vorgang, text.vorgangsposition, text.auf_lieferschein, text.textart = vorgangsnummer, 0, 1, 8
